...
预编译的安装包可从 [**Releases**](https://github.com/foodpm/DeepMatrix/releases) 页面下载。

| 平台              | 格式    | 说明                                      |
|-------------------|---------|------------------------------------------|
| Windows x64       | .exe    | NSIS 安装包，内含 Python 运行环境          |
| macOS Intel       | .dmg    | 已签名并公证                               |
| macOS Apple Silicon | .dmg  | 已签名并公证                               |

> 点击跳转：[**Releases**](https://github.com/foodpm/DeepMatrix/releases)
## 功能特性 | Features
